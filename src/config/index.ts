...
export const CAKE_PER_BLOCK = new BigNumber(0.001)
export const BLOCKS_PER_YEAR = new BigNumber((60 / BSC_BLOCK_TIME) * 60 * 24 * 365) // 10512000
export const CAKE_PER_YEAR = CAKE_PER_BLOCK.times(BLOCKS_PER_YEAR)
export const BASE_URL = 'https://goldenretriever-finance.com'
export const BASE_EXCHANGE_URL = 'https://exchange.goldenretriever-finance.com'
